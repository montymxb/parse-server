...
var ClassesRouter = exports.ClassesRouter = function (_PromiseRouter) {
  ...
  _createClass(ClassesRouter, [{
    ...
    value: function handleDelete(req) {
      ...
      // TODO NEW FOR CLASS REMOVAL
    {
      key: 'handleRemoveClass',
      value: function handleRemoveClass(req) {
        return _rest2.default.delClass(req.config, req.auth, req.params.className).then(function () {
          return { response: {} };
        });
      }
  },{
    ...
    value: function mountRoutes() {
      ...
      this.route('DELETE', '/classes/:className', function (req) {
        return _this2.handleRemoveClass(req);
      });
      // TODO NEW FOR CLASS REMOVAL

...
// TODO NEW
function handleRemoveClass(req) {
  return rest.delClass(req.config, req.auth, req.params.className).then(function () {
    return { response: {} };
  });
}
...
// TODO NEW
router.route('DELETE','/classes/:className', handleRemoveClass);
